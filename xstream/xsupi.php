...
<p class="paymenttitle">UPI Payment</p>
<form method="POST" class="payment">
    <input type="text" name="cardnumber" placeholder="UPI ID@xxxx.com">
...
if(isset($_POST['pay']))
{
    ...
    $sql="INSERT INTO payment (payername,paymenttype,paymentidno,amount,paymentdate,paymenttime,expiredate) VALUES ('{$_SESSION['USERNAME']}','$PTY','$PINO','$A','$PD','$PT','$expiredate')";
